...
exports.defaultDiff2HtmlUIConfig = __assign(__assign({}, diff2html_1.defaultDiff2HtmlConfig), {
...
var Diff2HtmlUI = (function () {
  ...
  Diff2HtmlUI.prototype.synchronisedScroll = function () {
    this.targetElement.querySelectorAll(".d2h-file-wrapper").forEach(function (wrapper) {
      var _a = Array().slice.call(wrapper.querySelectorAll(".d2h-file-side-diff")),
        left = _a[0],
        right = _a[1]
  ...
  Diff2HtmlUI.prototype.highlightCode = function () {
    ...
    files.forEach(function (file) {
      ...
      codeLines.forEach(function (line) {
        if (_this.hljs === null) return
        var text = line.textContent
        var lineParent = line.parentNode
        if (text === null || lineParent === null || !_this.isElement(lineParent)) return
